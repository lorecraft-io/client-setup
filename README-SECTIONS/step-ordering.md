...
> **Note:** Step 6 (Productivity Tools) is all optional — install only the tools you use. Step 7 (Second Brain) is the biggest step with four sub-parts (7a-7d). The Final Step (Status Line) is the wrap-up that wires everything together — your status indicators show what's active across all the tools.
