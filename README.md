...
This is a quick reference for terminal basics, launching Claude, useful commands, and tips. **Read this after completing Step 1**, especially if you're new to working in a terminal.
